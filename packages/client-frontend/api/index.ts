...
export function registerApi(data: Omit<AuthRegisterRequestBody, 'type'>) {
  return request<ResponseBaseData<AuthRegisterResponseData>>('/api/auth/register', {
    method: 'POST',
    body: {
      type: 'email',
      ...data,
...
export function postOauthGithubLoginApi(code: string) {
  return request<ResponseBaseData<OAuthGithubResponseData>>('/api/oauth/github', {
    method: 'POST',
    body: { code },
  })
}
...
export function getQuestionnaireListApi() {
  return request<ResponseBaseData<QuestionnaireClientListResponseData>>(`/api/questionnaire`)
}

export function getQuestionnaireApi(id: string) {
  return request<ResponseBaseData<QuestionnaireClientResponseData>>(`/api/questionnaire/${id}`)
}

export function postQuestionnaireSubmitApi(questionnaireId: number, data: QuestionnaireClientSubmitRequestBody) {
...
export function getQuestionnaireResponseApi(id: string) {
  return request<ResponseBaseData<QuestionnaireClientQuestionnaireResponseResponseData>>(
